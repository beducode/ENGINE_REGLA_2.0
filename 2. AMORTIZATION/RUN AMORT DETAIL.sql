...
-- CALL SP_IFRS_IMP_SIMULATION_DATA(NULL, NULL, 'P'); -- 0
-- ============== #PREP ==============
----- #1
...
-- CALL SP_IFRS_AMT_SYNC_BEFORE_PROCESS(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_PROCESS_TRAN_DAILY(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_ACCT_SWITCH(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_GENERATE_PAYM_SCHD(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_CALC_ACCT_EIR(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_ACCT_LBM_PROCESS(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_ACCT_SL_PROCESS(NULL, NULL, 'P');
-- CALL SP_IFRS_AMT_JOURNAL_RPT(NULL, NULL, 'P');
-- ============== CALCULATION AMORTIZATION ==============
END;
$$;