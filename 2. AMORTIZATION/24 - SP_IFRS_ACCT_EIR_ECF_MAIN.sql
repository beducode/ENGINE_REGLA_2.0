...
BEGIN 
    ...
    LOOP 
        ...
        CALL SP_IFRS_ACCT_EIR_GS_RANGE(P_ID1 => V_X, P_ID2 => V_ID2);
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || 'TMP_YEST_UNAMORT' || ' AS 
        SELECT 
            B.MASTERID                
            ,SUM(COALESCE(CASE             
                WHEN B.FLAG_CF = ''F'' 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || 'TEMP_TFC' || ' AS 
        SELECT MASTERID        
