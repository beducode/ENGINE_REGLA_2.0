CREATE OR REPLACE PROCEDURE SP_IFRS_ACCT_EIR_JRNL_INTM(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        ...
        V_TABLEINSERT4 := 'IFRS_ACCT_EIR_ACF_' || P_RUNID || '';
        V_TABLEINSERT5 := 'TMP_T5_' || P_RUNID || '';
        V_TABLEINSERT6 := 'TMP_T6_' || P_RUNID || '';
        V_TABLEINSERT7 := 'IFRS_ACCT_EIR_STOP_REV_' || P_RUNID || '';
        V_TABLEINSERT8 := 'IFRS_ACCT_EIR_COST_FEE_PREV_' || P_RUNID || '';
        V_TABLEINSERT9 := 'IFRS_IMA_AMORT_CURR_' || P_RUNID || '';
        V_TABLEINSERT10 := 'IFRS_ACCT_EIR_GAIN_LOSS_' || P_RUNID || '';
        V_TABLEINSERT11 := 'IFRS_ACCT_EIR_ACCRU_PREV_' || P_RUNID || '';
        V_TABLEINSERT12 := 'IFRS_ACCT_SWITCH_' || P_RUNID || '';
    ELSE 
        V_TABLEINSERT1 := 'IFRS_ACCT_JOURNAL_INTM';
        V_TABLEINSERT2 := 'IFRS_ACCT_COST_FEE';
        V_TABLEINSERT3 := 'IFRS_ACCT_EIR_COST_FEE_ECF';
        V_TABLEINSERT4 := 'IFRS_ACCT_EIR_ACF';
        V_TABLEINSERT5 := 'TMP_T5';
        V_TABLEINSERT6 := 'TMP_T6';
        V_TABLEINSERT7 := 'IFRS_ACCT_EIR_STOP_REV';
        V_TABLEINSERT8 := 'IFRS_ACCT_EIR_COST_FEE_PREV';
        V_TABLEINSERT9 := 'IFRS_IMA_AMORT_CURR';
        V_TABLEINSERT10 := 'IFRS_ACCT_EIR_GAIN_LOSS';
        V_TABLEINSERT11 := 'IFRS_ACCT_EIR_ACCRU_PREV';
        V_TABLEINSERT12 := 'IFRS_ACCT_SWITCH';
    END IF;
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '1');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '2');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '3');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '4');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '5');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '10');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '11');        
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '12');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '13');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '14');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '16');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '17');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '18');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '19');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '20');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '21');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '22');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '23');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '24');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '25');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '26');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '27');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '28');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '29');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '30');
    ...
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'DEBUG', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '31');
    ...
    ---- END
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'END', 'SP_IFRS_ACCT_EIR_JOURNAL_INTM', '');

    RAISE NOTICE 'SP_IFRS_ACCT_EIR_JRNL_INTM | AFFECTED RECORD : %', V_RETURNROWS2;
    -- ---------- ====== BODY ======
