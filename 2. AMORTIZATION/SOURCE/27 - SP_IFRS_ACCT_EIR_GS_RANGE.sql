CREATE OR REPLACE SP_IFRS_ACCT_EIR_GS_RANGE(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING, IN P_ID1 BIGINT DEFAULT NULL::BIGINT, IN P_ID2 BIGINT DEFAULT NULL::BIGINT)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
