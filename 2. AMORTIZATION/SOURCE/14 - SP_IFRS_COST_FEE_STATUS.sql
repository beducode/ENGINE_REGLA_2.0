CREATE OR REPLACE PROCEDURESP_IFRS_COST_FEE_STATUS(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING, IN P_MAT_LEVEL INTEGER DEFAULT 0, IN P_UNMAT_PL INTEGER DEFAULT 0)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
