CREATE OR REPLACE PROCEDURE SP_IFRS_LBM_ACCT_EIR_UPD_ACRU(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        V_TABLEINSERT1 := 'IFRS_LBM_ACCT_EIR_ACCRU_PREV_' || P_RUNID || '';
        V_TABLEINSERT2 := 'IFRS_LBM_ACCT_EIR_ACF_' || P_RUNID || '';
    ELSE 
        V_TABLEINSERT1 := 'IFRS_LBM_ACCT_EIR_ACCRU_PREV';
    ...
    -------- ====== BODY ======
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'START', 'SP_IFRS_LBM_ACCT_EIR_UPD_ACRU', '');
    ...
    ---- END
    CALL SP_IFRS_LOG_AMORT(V_CURRDATE, 'END', 'SP_IFRS_LBM_ACCT_EIR_UPD_ACRU', '');
