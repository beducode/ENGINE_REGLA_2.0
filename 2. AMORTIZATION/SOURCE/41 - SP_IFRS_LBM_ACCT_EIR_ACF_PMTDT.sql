CREATE OR REPLACE PROCEDURE SP_IFRS_LBM_ACCT_EIR_ACF_PMTDT(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
...
BEGIN 
            ...
            SELECT 
                ...
                LEFT JOIN (
                    SELECT 
                        ...
                        WHERE D.DOWNLOAD_DATE = ''' || CAST(V_CURRDATE AS VARCHAR(10)) || '''::DATE
    ...
    --EXECUTE IMMEDIATE 'DROP INDEX 'TMP_T2'_IDX1';  
    --EXECUTE IMMEDIATE 'CREATE INDEX 'TMP_T2'_IDX1 ON 'TMP_T2'(MASTERID,DOWNLOAD_DATE)';  
    -- UPDATE SUM_AMT 
