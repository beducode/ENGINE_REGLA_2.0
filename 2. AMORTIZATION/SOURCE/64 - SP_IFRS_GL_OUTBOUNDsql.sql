CREATE OR REPLACE PROCEDURESP_IFRS_GL_OUTBOUND(IN P_RUNID CHARACTER VARYING DEFAULT 'S_00000_0000'::CHARACTER VARYING, IN P_DOWNLOAD_DATE DATE DEFAULT NULL::DATE, IN P_PRC CHARACTER VARYING DEFAULT 'S'::CHARACTER VARYING, IN P_ROUND INTEGER DEFAULT 2, IN P_FUNCROUND INTEGER DEFAULT 0)
 LANGUAGE PLPGSQL
AS $$
DECLARE
    ---- DATE
