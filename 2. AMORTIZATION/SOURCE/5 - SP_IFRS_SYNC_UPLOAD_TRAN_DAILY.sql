...
BEGIN 
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT1 || ' 
        ( 
            ...
            ,A.TRANSACTION_AMOUNT::DOUBLE PRECISION AS ORG_CCY_AMT 
            ,A.TRANSACTION_AMOUNT::DOUBLE PRECISION * C.EXCHANGE_RATE AS EQV_LCY_AMT 
            ,A.DEBIT_CREDIT_FLAG 
            ,'''' AS TRX_SOURCE 
            ,'''' AS INTERNAL_NO 
            ,'''' AS REVOLVING_FLAG 
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT2 || ' 
        (
            ...
            ,''ACT'' AS STATUS 
            ,TRANSACTION_AMOUNT::DOUBLE PRECISION AS TRX_AMOUNT 
