...
BEGIN 
    ...
    IF P_PRC = 'S' THEN
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || V_TABLEINSERT4 || ' AS SELECT * FROM IFRS_IMP_DEFAULT_STATUS WHERE 0=1';
        EXECUTE (V_STR_QUERY);
    END IF;
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE CURR_RESTRU_SIFAT_PREVIOUS_ACCT_' || P_RUNID || ' AS
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE CURR_RESTRU_SIFAT_EXISTING_ACCT_' || P_RUNID || ' AS
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE CURR_WO_' || P_RUNID || ' AS 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE PREV_SURVIVE_' || P_RUNID || ' AS 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE PREV_SURVIVE_RESTRU_' || P_RUNID || ' AS 
    SELECT DISTINCT                 
    A.CUSTOMER_NUMBER                
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE CURR_SURVIVE_RESTRU_' || P_RUNID || ' AS 
    SELECT DISTINCT                 
    A.CUSTOMER_NUMBER                
    ,A.ACCOUNT_NUMBER                
    ,A.FLAG_RESTRU_COVID19                  
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'DROP TABLE IF EXISTS IFRS_IMP_DEFAULT_STATUS_' || P_RUNID || '';
    EXECUTE (V_STR_QUERY);

    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE IFRS_IMP_DEFAULT_STATUS_' || P_RUNID || ' AS 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE CIF_LEVEL_' || P_RUNID || ' AS 
    ...
    FROM IFRS_IMP_DEFAULT_STATUS_' || P_RUNID || '
    GROUP BY CUSTOMER_NUMBER, SUB_SEGMENT, FLAG_RESTRU_COVID19_CIF, SURVIVE_FLAG_CIF';
    EXECUTE (V_STR_QUERY);

    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'UPDATE IFRS_IMP_DEFAULT_STATUS_' || P_RUNID || ' A                              
