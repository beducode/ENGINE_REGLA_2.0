...
BEGIN 
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT || ' 
        (
            ...
            DOWNLOAD_DATE,    
            CASE WHEN COALESCE(OLD_ACCOUNT_NUMBER,'') = '' THEN ACCOUNT_NUMBER ELSE OLD_ACCOUNT_NUMBER END AS ACCOUNT_NUMBER,    
            ''W'' AS ACCOUNT_STATUS,    
            CASE WHEN COALESCE(CURRENCY,'') = '' THEN ''IDR'' ELSE CURRENCY END AS CURRENCY,     
            CASE WHEN COALESCE(OLD_CUSTOMER_NUMBER,'') = '' THEN CUSTOMER_NUMBER ELSE OLD_CUSTOMER_NUMBER END AS CUSTOMER_NUMBER,    
            B.DATA_SOURCE AS DATA_SOURCE,    
            1 AS EXCHANGE_RATE,    
            CASE WHEN COALESCE(OLD_ACCOUNT_NUMBER,'') = '' THEN ACCOUNT_NUMBER ELSE OLD_ACCOUNT_NUMBER END AS MASTERID,    
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT1 || ' 
        (
            ...
            COALESCE(RECOVERY_AMOUNT,0) AS TOTAL_RECOVERY,    
