---- DROP PROCEDURE SP_GENERATE_IMA_LENDING;

CREATE OR REPLACE PROCEDURE SP_GENERATE_IMA_LENDING(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_GENERATE_IMA_LENDING | AFFECTED RECORD : %', V_RETURNROWS2;
    ---------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_GENERATE_IMA_LENDING';
    V_OPERATION = 'INSERT';
