...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        ...
        V_TABLEINSERT2 := 'IFRS_SCENARIO_SEGMENT_GENERATE_QUERY_' || P_RUNID || '';
    ...
    ELSE 
        ...
        V_TABLEINSERT2 := 'IFRS_SCENARIO_SEGMENT_GENERATE_QUERY';
    ...
    LOOP
        ...
        V_STR_QUERY := V_STR_QUERY || 'INSERT INTO TMP_IFRS_PD_SCENARIO_DATA_NOLAG 
            ...
            JON ' || V_TABLEINSERT1 || ' B ON B.PKID = ' || V_SEGMENT.PD_RULE_ID || ' 
