...
BEGIN 
    ...
    LOOP
        ...
        V_STR_QUERY := V_STR_QUERY || 'INSERT INTO TMP_IFRS_PD_SCENARIO_DATA_NOLAG 
            ...
            JON ' || V_TABLEPDCONFIG || ' B ON B.PKID = ' || V_SEGMENT.PD_RULE_ID || ' 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'DROP TABLE IF EXISTS TEMP_DEFAULT ';
    EXECUTE (V_STR_QUERY);

    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE TEMP_DEFAULT AS 
        SELECT * FROM IFRS_DEFAULT_NOLAG 
    ...
    V_STR_QUERY := V_STR_QUERY || 'UPDATE TMP_IFRS_PD_SCENARIO_DATA_NOLAG A
        ...
        WHERE A.BUCKET_GROUP = C.BUCKET_GROUP 
        AND C.IS_DELETE = 0 
