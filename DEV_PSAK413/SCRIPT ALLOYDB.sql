...
CREATE INDEX IF NOT EXISTS NCI_IFRS_IMP_PD_FL_TERM_YEARLY
ON IFRS_IMP_PD_FL_TERM_YEARLY USING BTREE
(DOWNLOAD_DATE ASC NULLS LAST, PD_EFFECTIVE_DATE ASC NULLS LAST, SCALAR_EFFECTIVE_DATE ASC NULLS LAST, EIL_MODEL_ID ASC NULLS LAST, BUCKET_ID ASC NULLS LAST, FL_SEQ ASC NULLS LAST)
TABLESPACE PG_DEFAULT

SELECT PG_TERMINATE_BACKEND(PID) 
FROM PG_STAT_ACTIVITY 
WHERE PID <> PG_BACKEND_PID() AND DATNAME = 'IFRS9'