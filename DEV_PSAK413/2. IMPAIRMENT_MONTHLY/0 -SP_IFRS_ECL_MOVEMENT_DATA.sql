...
BEGIN 
    ...
    IF P_PRC = 'S' THEN
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE IF NOT EXISTS IFRS_ECL_MOVEMENT_DATA 
            (
                DOWNLOAD_DATE DATE
                ,URUT INT
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE IF NOT EXISTS VM_IMA_FACILITY_ACCOUNT 
            (
                DOWNLOAD_DATE DATE
                ,DATA_SOURCE VARCHAR(20)
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || V_TMPTABLE1 || ' 
        (
            DOWNLOAD_DATE DATE 
            ,DATA_SOURCE VARCHAR(20) 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || V_TMPTABLE2 || ' 
        (
            DOWNLOAD_DATE DATE 
            ,DATA_SOURCE VARCHAR(20) 
            ,ECL_UNIQUE_ID VARCHAR(100) 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || V_TMPTABLE3 || ' 
        (
            DOWNLOAD_DATE DATE 
            ,DATA_SOURCE VARCHAR(20) 
            ,ECL_UNIQUE_ID VARCHAR(100) 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE ' || V_TMPTABLE4 || ' 
        (
            DOWNLOAD_DATE DATE 
            ,DATA_SOURCE VARCHAR(20) 
            ,ECL_UNIQUE_ID VARCHAR(100) 
