...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        ...
        V_TABLEINSERT5 := 'IFRS_EAD_RESULT_NONPRK_' || P_RUNID || '';
        V_TABLEINSERT6 := 'IFRS_EAD_RESULT_PRK_' || P_RUNID || '';
        V_TABLEINSERT7 := 'IFRS_EAD_RESULT_PRK_MONTHLY';
        V_TABLEINSERT8 := 'IFRS_IMP_PD_FL_TERM_STRUCTURE_' || P_RUNID || '';
        V_TABLEINSERT9 := 'IFRS_PD_TERM_STRUCTURE_NOFL_' || P_RUNID || '';
    ELSE 
        ...
        V_TABLEINSERT7 := 'IFRS_EAD_RESULT_PRK_MONTHLY';
        V_TABLEINSERT8 := 'IFRS_IMP_PD_FL_TERM_STRUCTURE';
        V_TABLEINSERT9 := 'IFRS_PD_TERM_STRUCTURE_NOFL';
    END IF;
