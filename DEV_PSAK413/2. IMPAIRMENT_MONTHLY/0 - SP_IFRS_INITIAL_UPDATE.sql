...
BEGIN 
    ...
    V_RETURNROWS2 := 0;
    -------- ====== VARIABLE ======
    ----- TEMPORARY BEFORE SPLIT PROCESS
    CALL SP_IFRS_IMP_INITIAL_UPDATE(P_RUNID, NULL, P_PRC);
    CALL SP_IFRS_EXEC_RULE(P_RUNID, NULL, P_PRC);
    CALL SP_IFRS_IMP_GENERATE_RULE_SEGMENT(P_RUNID, NULL, P_PRC);
    CALL SP_IFRS_IMP_ECL_UPDATE_PORTFOLIO(P_RUNID, NULL, P_PRC);
    CALL SP_IFRS_IMP_ECL_UPDATE_EIR(P_RUNID, NULL, P_PRC);
    ...
    RAISE NOTICE 'SP_IFRS_INITIAL_UPDATE | SYNC CONFIGURATION FROM WORKFLOW';
    
        -------- ====== LOG ======
    V_TABLEDEST = 'SYNC TABLE CONFIGURATION';
    V_COLUMNDEST = '-';
