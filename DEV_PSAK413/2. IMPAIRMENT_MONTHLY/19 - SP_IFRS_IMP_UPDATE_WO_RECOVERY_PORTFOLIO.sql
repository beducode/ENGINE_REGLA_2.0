...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        ...
        V_TABLEINSERT6 := 'IFRS_SCENARIO_SEGMENT_GENERATE_QUERY_' || P_RUNID || '';
    ELSE 
        ...
        V_TABLEINSERT6 := 'IFRS_SCENARIO_SEGMENT_GENERATE_QUERY';
    END IF;
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TBLU_CUST_GRADE_' || P_RUNID || ' AS 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE IMA_CS_' || P_RUNID || ' AS 
