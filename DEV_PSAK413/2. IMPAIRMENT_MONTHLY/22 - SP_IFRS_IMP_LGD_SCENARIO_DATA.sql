...
BEGIN 
    ...
    ELSE 
        ...
        V_TABLEINSERT5 := 'IFRS_SCENARIO_SEGMENT_GENERATE_QUERY';
        V_TABLEINSERT6 := 'IFRS_DEFAULT';
    END IF;
    ...
    LOOP
        ...
        LEFT JOIN ' || V_TABLEINSERT6 || ' C ON B.DEFAULT_RULE_ID = C.RULE_ID AND A.MASTERID = C.MASTERID AND A.DOWNLOAD_DATE = C.DOWNLOAD_DATE              
