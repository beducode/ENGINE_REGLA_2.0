...
DECLARE
    ...
    V_TABLEGETDATAPAST1 VARCHAR(100);
    V_TABLEGETDATAPAST2 VARCHAR(100);
    V_TABLEGETDATAPAST3 VARCHAR(100);
    V_TABLEGETDATAPAST4 VARCHAR(100);
    V_TABLEGETDATAPAST5 VARCHAR(100);
    V_TABLEGETDATAPAST6 VARCHAR(100);
...
BEGIN 
    ...
    IF P_PRC = 'S' THEN 
        ...
        V_TABLEINSERT4 := 'IFRS_PD_CHR_DATA_' || P_RUNID || '';
        V_TABLEINSERT5 := 'IFRS_PD_CHR_BASE_DATA_' || P_RUNID || '';
        V_TABLEINSERT6 := 'IFRS_PD_CHR_SUMM_' || P_RUNID || '';
        V_TABLEINSERT7 := 'IFRS_PD_SCENARIO_DATA_' || P_RUNID || '';
    ...
    ELSE 
        ...
        V_TABLEINSERT4 := 'IFRS_PD_CHR_DATA';
        V_TABLEINSERT5 := 'IFRS_PD_CHR_BASE_DATA';
        V_TABLEINSERT6 := 'IFRS_PD_CHR_SUMM';
        V_TABLEINSERT7 := 'IFRS_PD_SCENARIO_DATA';
        V_TABLEPDCONFIG := 'IFRS_PD_RULES_CONFIG';
    END IF;

    V_TABLEGETDATAPAST1 := 'IFRS_PD_SCENARIO_DATA';
    V_TABLEGETDATAPAST2 := 'IFRS_PD_CHR_BASE_DATA';
    ...
    IF P_PRC = 'S' THEN
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT4 || ' AS SELECT * FROM IFRS_PD_CHR_DATA WHERE 0=1';
        EXECUTE (V_STR_QUERY);
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT5 || ' AS SELECT * FROM IFRS_PD_CHR_BASE_DATA WHERE 0=1';
        EXECUTE (V_STR_QUERY);
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT6 || ' AS SELECT * FROM IFRS_PD_CHR_SUMM WHERE 0=1';
        EXECUTE (V_STR_QUERY);
    END IF;
    ------ ====== PRE SIMULATION TABLE ======
    ...
    -------- ====== BODY ======
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'DELETE FROM ' || V_TABLEGETDATAPAST2 || ' A         
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEGETDATAPAST2 || ' (DOWNLOAD_DATE        
    ,PROJECTION_DATE        
    ,PD_RULE_ID        
    ,PD_RULE_NAME        
    ,BUCKET_GROUP        
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO TMP_IFRS_PD_CHR_BASE_DATA ';
    V_STR_QUERY := V_STR_QUERY || 'SELECT A.* FROM ' || V_TABLEINSERT5 || ' A        
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT6 || ' (DOWNLOAD_DATE        
    ,PROJECTION_DATE        
    ,PD_RULE_ID        
    ,PD_RULE_NAME        
    ,SEGMENT        
    ...
    SELECT A.* FROM ' || V_TABLEINSERT6 || ' A 
