...
BEGIN 
    ...
    V_TABLEINSERT5 := 'IFRS_EAD_RESULT_NONPRK';
    V_TABLEINSERT6 := 'IFRS_EAD_RESULT_PRK';
    V_TABLEINSERT7 := 'IFRS_EAD_RESULT_PRK_MONTHLY';
    ...
    IF P_PRC = 'S' THEN
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT3 || ' AS SELECT * FROM IFRS_ECL_RESULT_DETAIL WHERE 0=1';
        EXECUTE (V_STR_QUERY);
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT4 || ' AS SELECT * FROM IFRS_ECL_RESULT_HEADER WHERE 0=1';
        EXECUTE (V_STR_QUERY);
    END IF;
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_ECL_PD_MONTHLY_ECL_' || P_RUNID || ' AS
      SELECT      
        A.DOWNLOAD_DATE,      
        A.PD_RULE_ID,      
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_ECL_PD_FL_MONTHLY_ECL_' || P_RUNID || '  AS 
    SELECT      
      A.DOWNLOAD_DATE,      
      A.PD_RULE_ID,      
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_ECL_PD_YEARLY_' || P_RUNID || ' AS     
    SELECT       
      A.DOWNLOAD_DATE,      
      A.CURR_DATE,      
      A.PD_RULE_ID,       
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_ECL_PD_FL_YEARLY_' || P_RUNID || ' AS     
    SELECT      
        A.DOWNLOAD_DATE,      
        A.PD_RULE_ID,      
        A.ME_MODEL_ID AS PD_ME_MODEL_ID,      
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_ECL_LGD_' || P_RUNID || ' AS     
