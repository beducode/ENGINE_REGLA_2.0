...
BEGIN 
    ...
    CALL SP_IFRS_IMP_NOMINATIVE_OUTPUT(P_RUNID, V_CURRDATE, P_PRC);
    CALL SP_IFRS_IMP_DASHBOARD_DATA(P_RUNID, V_CURRDATE, P_PRC);
    CALL SP_IFRS_EXCEPTION_REPORT(P_RUNID, V_CURRDATE, P_PRC);
