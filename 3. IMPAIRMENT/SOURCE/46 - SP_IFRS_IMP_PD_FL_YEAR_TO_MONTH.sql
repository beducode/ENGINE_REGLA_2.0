...
BEGIN 
    ...
    ,CASE WHEN F.PD_OVERRIDE IS NULL THEN PD_RATE ELSE F.PD_OVERRIDE END AS PD_RATE 
    -- ,PD_RATE
    ...
    LEFT JOIN IFRS_PD_FL_OVERRIDE F ON B.PD_MODEL_ID = F.PD_RULE_ID AND B.EFF_DATE = F.EFFECTIVE_DATE AND C.FL_YEAR = F.FL_YEAR AND C.FL_MONTH = F.FL_MONTH  
