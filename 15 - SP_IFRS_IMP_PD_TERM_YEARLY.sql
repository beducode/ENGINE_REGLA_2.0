...
BEGIN 
    ...
    FROM VW_IFRS_MAX_BUCKET AS B, IFRS_PD_RULES_CONFIG AS C 
    ...
    INNER JOIN IFRS_PD_RULES_CONFIG C ON A.PD_RULE_ID = C.PKID AND C.IS_DELETE = 0 AND C.ACTIVE_FLAG = 1        
    ...
    INNER JOIN IFRS_PD_RULES_CONFIG C ON B.PKID = C.SEGMENTATION_ID AND C.IS_DELETE = 0  AND PD_METHOD = ''EXT'' AND C.ACTIVE_FLAG = 1 
