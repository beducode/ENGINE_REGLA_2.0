CREATE OR REPLACE PROCEDURE SP_IFRS_ECL_SPECIAL_REASON(v_ECLID NUMBER DEFAULT (0),
...
BEGIN
    ...
    DELETE IFRS.IFRS_ECL_RESULT_DETAIL_CALC
    ...
    MERGE INTO IFRS.IFRS_ECL_RESULT_DETAIL_CALC A
    ...
    MERGE INTO IFRS.IFRS_ECL_RESULT_DETAIL A
    USING
        (SELECT A2.MASTERID,
                B2.ECL_AMOUNT,
                A2.RESERVED_VARCHAR_1 AS SPECIAL_REASON
         FROM IFRS.GTMP_IFRS_MASTER_ACCOUNT A2
                  JOIN IFRS.IFRS_ECL_RESULT_DETAIL_CALC B2
