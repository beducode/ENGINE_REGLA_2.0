CREATE OR REPLACE PROCEDURE IFRS9_BCA.SP_IFRS_ECL_DISASTER_LOAN_CALC_BCA (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_ECL_DISASTER_LOAN_CALC_BCA';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    JOIN ' || V_OWNER || '.TBLU_DISASTER_LOAN B
