CREATE OR REPLACE PROCEDURE IFRS9_BCA.SP_IFRS_ECL_MODEL_CONFIG (
...
BEGIN
    V_SP_NAME := 'SP_IFRS_ECL_MODEL_CONFIG';
    ...
    IF V_PRC = 'S' THEN 
        V_TABLEINSERT1 := 'IFRS_ECL_MODEL_CONFIG_' || V_RUNID;
    ELSE 
...
EXCEPTION
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20002, 'SP_IFRS_ECL_MODEL_CONFIG FAILED: ' || SQLERRM);
END;