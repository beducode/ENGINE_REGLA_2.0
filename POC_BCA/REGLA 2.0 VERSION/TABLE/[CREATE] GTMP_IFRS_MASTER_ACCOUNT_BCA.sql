CREATE GLOBAL TEMPORARY TABLE IFRS9_BCA.GTMP_IFRS_MASTER_ACCOUNT_BCA
...
AS
    SELECT PKID,
        ...
        PREPAYMENT_SEGMENT,
        PREPAYMENT_RULE_ID
    FROM IFRS9_BCA.IFRS_MASTER_ACCOUNT
    WHERE DOWNLOAD_DATE = TO_DATE('2024-12-30','YYYY-MM-DD')