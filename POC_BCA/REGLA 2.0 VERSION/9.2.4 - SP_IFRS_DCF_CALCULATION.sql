CREATE OR REPLACE PROCEDURE IFRS9_BCA.SP_IFRS_DCF_CALCULATION (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_DCF_CALCULATION';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    IF V_PRC = 'S' THEN 
        ...
        V_TABLESELECT2 := 'GTMP_IFRS_MASTER_ACCOUNT_BCA_' || V_RUNID;
    ...
    ELSE 
        ...
        V_TABLESELECT2 := 'GTMP_IFRS_MASTER_ACCOUNT_BCA';
