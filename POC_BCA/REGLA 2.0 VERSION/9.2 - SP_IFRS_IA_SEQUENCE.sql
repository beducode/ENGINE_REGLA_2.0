CREATE OR REPLACE PROCEDURE IFRS9_BCA.SP_IFRS_IA_SEQUENCE (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_IA_SEQUENCE';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    ----------------------------------------------------------------
    V_STR_QUERY := 'BEGIN IFRS9_BCA.SP_IFRS_INITIAL_IA_OVERRIDE(:1, :2, :3, :4, :5); END;';
    ...
    V_STR_QUERY := 'BEGIN IFRS9_BCA.SP_IFRS_INSERT_IA_OVERRIDE(:1, :2, :3, :4, :5); END;';
    ...
    V_STR_QUERY := 'BEGIN IFRS9_BCA.SP_IFRS_INSERT_DCF(:1, :2, :3, :4, :5); END;';
    ...
    V_STR_QUERY := 'BEGIN IFRS9_BCA.SP_IFRS_DCF_CALCULATION(:1, :2, :3, :4); END;';
