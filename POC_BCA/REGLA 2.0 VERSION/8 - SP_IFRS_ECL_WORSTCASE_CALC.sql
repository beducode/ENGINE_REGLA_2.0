CREATE OR REPLACE PROCEDURE IFRS9_BCA.SP_IFRS_ECL_WORSTCASE_CALC_BCA (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_ECL_WORSTCASE_CALC_BCA';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    V_STR_QUERY := 'INSERT INTO ' || V_OWNER || '.' || V_TABLESELECT1 || ' (PKID,
                    DOWNLOAD_DATE,
                    MASTERID,
                    MASTER_ACCOUNT_CODE,
                    CUSTOMER_NUMBER,
        ...
        SELECT A.PKID,
          ...
          FROM ' || V_OWNER || '.' || V_TABLESELECT2 || '  A
               JOIN ' || V_OWNER || '.TBLU_WORSTCASE_LIST B
