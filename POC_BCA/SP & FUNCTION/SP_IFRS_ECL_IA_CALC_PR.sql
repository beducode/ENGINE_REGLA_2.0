CREATE OR REPLACE PROCEDURE SP_IFRS_ECL_IA_CALC_PR(v_ECLID NUMBER DEFAULT(0), v_DOWNLOADDATE DATE DEFAULT('1-JAN-1900'))
AS
...
BEGIN
    ...
    SP_IFRS_ECL_UNPROCESSED_IA_PR(v_ECLID, v_DOWNLOADDATE);
