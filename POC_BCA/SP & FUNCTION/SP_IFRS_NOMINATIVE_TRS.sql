CREATE OR REPLACE PROCEDURE  SP_IFRS_NOMINATIVE_TRS
AS
    v_CURRDATE      DATE;
    v_LASTMONTH     DATE;
    v_SESSIONID     VARCHAR2(100);
    v_SOURCETYPE    VARCHAR2(100):= 'TRS';
    v_DATASOURCE    VARCHAR2(100):= 'KTP';
...
BEGIN
    ...
    SELECT
        ...
        IMA.RESERVED_VARCHAR_5  AS "INSTRUMENT",
        IMA.RESERVED_VARCHAR_4  AS "INV_TYPE",
        IMA.LOAN_START_DATE     AS "START_DATE",
        IMA.LOAN_DUE_DATE       AS "MATURITY_DATE",
        IMA.RESERVED_DATE_1     AS "SETTLE_DATE",
        ...
        IMA.RESERVED_VARCHAR_1                                      AS "SWIFT_CODE",
        IMA.RESERVED_VARCHAR_6                                      AS "SEC_NAME",
        NVL(IMA.RESERVED_AMOUNT_10,0)                               AS "COA_BAL",
        NVL(IMA.RESERVED_AMOUNT_4,0)                                AS "PRINCIPAL_AMOUNT_CCY",
        NVL(IMA.RESERVED_AMOUNT_4,0) * NVL(IMA.EXCHANGE_RATE,1)     AS "PRINCIPAL_AMOUNT_LCL",
        NVL(IMA.RESERVED_AMOUNT_6,0)                                AS "INTEREST_RECEIVABLE_CCY",
        NVL(IMA.RESERVED_AMOUNT_6,0) * NVL(IMA.EXCHANGE_RATE,1)     AS "INTEREST_RECEIVABLE_LCL",
        NVL(IMA.RESERVED_AMOUNT_5,0)                                AS "PREMI_DISCOUNT_AMOUNT_CCY",
        NVL(IMA.RESERVED_AMOUNT_5,0) * NVL(IMA.EXCHANGE_RATE,1)     AS "PREMI_DISCOUNT_AMOUNT_LCL",
        NVL(IMA.RESERVED_AMOUNT_3,0)                                AS "COST_AMOUNT_CCY",
        NVL(IMA.RESERVED_AMOUNT_3,0) * NVL(IMA.EXCHANGE_RATE,1)     AS "COST_AMOUNT_LCL"
