CREATE OR REPLACE PROCEDURE SP_IFRS_INSERT_GTMP_FROM_IMA(v_DOWNLOADDATE DATE DEFAULT NULL, v_DATASOURCE VARCHAR2 DEFAULT 'ALL')
AS
...
BEGIN
    IF v_DOWNLOADDATE IS NOT NULL THEN
        ...
        v_QUERY :=
        'INSERT /*+ PARALLEL(GTMP_IFRS_MASTER_ACCOUNT,8) */ INTO GTMP_IFRS_MASTER_ACCOUNT
        (
            PKID,
            DOWNLOAD_DATE,
            MASTERID,
        ...
        SELECT /*+ PARALLEL(IFRS_MASTER_ACCOUNT,8) */
            PKID,
            DOWNLOAD_DATE,
            MASTERID,
            MASTER_ACCOUNT_CODE,
