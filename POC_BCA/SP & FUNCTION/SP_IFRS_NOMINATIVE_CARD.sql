CREATE OR REPLACE PROCEDURE SP_IFRS_NOMINATIVE_CARD
AS
    v_CURRDATE      DATE;
    v_LASTMONTH     DATE;
    v_SESSIONID     VARCHAR2(100);
    v_SOURCETYPE    VARCHAR2(100):= 'CARD';
    v_DATASOURCE    VARCHAR2(100):= 'CRD';
...
BEGIN
    ...
    SELECT
        ...
        IMA.RESERVED_AMOUNT_4   AS "DELINQUENCY",
        ''                      AS "SEGMENTATION",
        ...
        NVL(IMA.INTEREST_ACCRUED,0)                                                AS "SALDO_YADIT_CCY",
        NVL(IMA.INTEREST_ACCRUED,0) * NVL(IMA.EXCHANGE_RATE,1)                     AS "SALDO_YADIT_LCL",
        ...
        NVL(IMA.PLAFOND, 0)                                                         AS "LIMIT_AMT",
        NVL(IMA.RESERVED_AMOUNT_14, 0)                                              AS "UNUSED_AMT"
