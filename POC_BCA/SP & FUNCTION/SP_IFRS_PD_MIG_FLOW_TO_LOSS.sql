CREATE OR REPLACE PROCEDURE SP_IFRS_PD_MIG_FLOW_TO_LOSS(V_EFF_DATE DATE)
AS
  v_COUNT   NUMBER;
  v_CURSOR NUMBER;
  v_MAX_ID  NUMBER;
...
BEGIN
    ...
    DELETE IFRS_PD_MIG_FLOW_TO_LOSS
    ...
    WHILE v_CURSOR <= v_COUNT LOOP
        ...
        EXECUTE IMMEDIATE ' TRUNCATE TABLE TMP_IFRS_PD_MIG_FLOW_TO_LOSS ';

        v_TEMP := v_MAX_ID;
        WHILE v_TEMP > 0 LOOP

            INSERT INTO TMP_IFRS_PD_MIG_FLOW_TO_LOSS
            (
                BASE_DATE,
                EFF_DATE,
                PD_RULE_ID,
              ...
              SELECT C.BASE_DATE,
                ...
                LEFT JOIN TMP_IFRS_PD_MIG_FLOW_TO_LOSS D
        ...
        INSERT INTO IFRS_PD_MIG_FLOW_TO_LOSS
        (
            EFF_DATE,
            BASE_DATE,
            PD_RULE_ID,
        ...
        SELECT
            ...
            A.BUCKET_ID,
            A.FLOW_TO_LOSS
        FROM TMP_IFRS_PD_MIG_FLOW_TO_LOSS A
