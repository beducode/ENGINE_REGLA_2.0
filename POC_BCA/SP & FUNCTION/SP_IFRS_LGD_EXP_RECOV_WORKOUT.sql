CREATE OR REPLACE PROCEDURE SP_IFRS_LGD_EXP_RECOV_WORKOUT(V_EFF_DATE DATE)
AS
    V_DATE DATE;
BEGIN
    DELETE FROM IFRS_LGD_EXP_RECOVERY_WORKOUT
    ...
    WHILE V_DATE <= V_EFF_DATE LOOP
        INSERT INTO IFRS_LGD_EXP_RECOVERY_WORKOUT
        (
            EFF_DATE,
            DOWNLOAD_DATE,
            LGD_RULE_ID,
