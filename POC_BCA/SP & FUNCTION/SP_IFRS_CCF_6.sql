CREATE OR REPLACE PROCEDURE SP_IFRS_CCF_6 (
...
BEGIN
   ...
   SELECT ADD_MONTHS (V_CURRDATE, -6) INTO V_PREVDATE FROM DUAL;
   ...
   DELETE /*+ PARALLEL(12) */ IFRS_CCF_HEADER_6
    WHERE DOWNLOAD_DATE >= V_CURRDATE;

   COMMIT;

       DELETE /*+ PARALLEL(12) */ IFRS_CCF_DETAIL_6 WHERE DOWNLOAD_DATE >= V_CURRDATE; COMMIT;
   DELETE IFRS_CCF_DETAIL_PROCESS_6
    WHERE DOWNLOAD_DATE >= V_CURRDATE;

   COMMIT;

   DELETE /*+ PARALLEL(12) */ IFRS_CCF_DETAIL_UNPROCESS_6
    WHERE DOWNLOAD_DATE >= V_CURRDATE;

   COMMIT;

       INSERT /*+ PARALLEL(12) */ INTO IFRS_CCF_DETAIL_6
       (DOWNLOAD_DATE,
        CURRENT_DATE,
        ACCOUNT_NUMBER,
        CUSTOMER_NAME,
   ...
   INSERT /*+ PARALLEL(12) */ INTO IFRS_CCF_DETAIL_PROCESS_6 (PKID,
                                        DOWNLOAD_DATE,
                                        CURRENT_DATE,
                                        PREVIOUS_DATE,
                                        FACILITY_NUMBER,
   ...
   UPDATE /*+ PARALLEL(12) */ IFRS_CCF_DETAIL_PROCESS_6
      SET OS_SELISIH =
             CASE
   ...
   INSERT /*+ PARALLEL(12) */ INTO IFRS_CCF_DETAIL_UNPROCESS_6
      SELECT *
        FROM IFRS_CCF_DETAIL_PROCESS_6
...
--    INSERT INTO IFRS_CCF_DETAIL_UNPROCESS_6
--       SELECT *
--         FROM IFRS_CCF_DETAIL_PROCESS_6
...
--    COMMIT;
   ...
   INSERT /*+ PARALLEL(12) */ INTO IFRS_CCF_HEADER_6 (PKID,
                                DOWNLOAD_DATE,
                                SEGMENTATION,
                                SEGMENTATION_ID,
                                CCF_RULE_ID,
