CREATE OR REPLACE PROCEDURE SP_IFRS_PD_MIG_MMULT
AS
   v_CURRDATE DATE;
   v_MAX  NUMBER;
   v_CURSOR NUMBER;
               ...
               SELECT
                ...
                FROM
                    (
                        ...
                        FROM IFRS_PD_MIG_MMULT A
                        INNER JOIN IFRS_PD_MIG_MMULT B
                        ON A.PD_RULE_ID = B.PD_RULE_ID
