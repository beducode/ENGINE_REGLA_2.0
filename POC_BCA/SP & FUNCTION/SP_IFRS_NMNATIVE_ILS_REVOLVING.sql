CREATE OR REPLACE PROCEDURE SP_IFRS_NMNATIVE_ILS_REVOLVING(v_DOWNLOADDATECUR DATE DEFAULT ('1-JAN-1900')) AS
  V_CURRDATE DATE;
BEGIN
  ...
  for rec in (SELECT REPORT_DATE,
               ...
               WHERE DATA_SOURCE = 'ILS'
                 ...
                 and (SEGMENT NOT IN ('EMPLOYEE LOAN','KKB AUTOMOBIL','KKB RODA 2')
                 OR NVL(SEGMENT, ' ') = ' '))
  loop
