CREATE OR REPLACE PROCEDURE SP_IFRS_INSRT_GTMP_IMA_PREV_PR(v_DOWNLOADDATE DATE DEFAULT NULL, v_DATASOURCE VARCHAR2 DEFAULT 'ALL')
AS
...
BEGIN
    IF v_DOWNLOADDATE IS NOT NULL THEN
        ...
        WHERE DOWNLOAD_DATE = ''' || TO_CHAR(v_DOWNLOADDATE, 'dd MON yyyy') || ''' AND MASTERID IN (SELECT MASTERID FROM TMP_IMA_PARTIAL)';
