CREATE OR REPLACE PROCEDURE VLD_IFRS_NOMI_VS_GL_ECL
AS
BEGIN
    EXECUTE IMMEDIATE 'TRUNCATE TABLE IFRS_NOMI_VS_GL_ECL';

    INSERT INTO GTMP_REKON_BKPI
          ...
          SELECT DOWNLOAD_DATE,
            ...
            FROM (SELECT N.REPORT_DATE
                    ...
                    FROM IFRS_NOMINATIVE N
                         LEFT JOIN GTMP_REKON_BKPI REKON
