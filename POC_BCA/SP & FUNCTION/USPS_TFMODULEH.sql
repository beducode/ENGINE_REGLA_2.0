CREATE OR REPLACE PROCEDURE USPS_TFMODULEH
(
...
BEGIN
    ...
    V_QUERY :=
        ...
        FROM IFRS_MASTER_ACCOUNT A
            LEFT JOIN IFRS_MASTER_PRODUCT_PARAM P ON A.PRODUCT_CODE=P.PRD_CODE
        ...
        WHERE A.DATA_SOURCE IN (SELECT VALUE1 FROM TBLM_COMMONCODEDETAIL WHERE COMMONCODE = ''B96'') '
