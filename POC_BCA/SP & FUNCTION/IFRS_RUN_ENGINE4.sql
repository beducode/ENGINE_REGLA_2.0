CREATE OR REPLACE PROCEDURE IFRS_RUN_ENGINE4
as
  v_date date;
begin
    v_date := '30 JUN 2017';
        ...
        (
            ...
            case pool_id
                when '200' then 'PD_CREDIT CARD INDIVIDU'
                when '201' then 'PD_CREDIT CARD ORGANIZATION'
            end pd_segment,
            'DPD5_1' bucket_group,
            ...
            and pool_classification_date is not null
        ) B
        ...
        EXECUTE IMMEDIATE 'ALTER TABLE IFRS_MASTER_ACCOUNT_MONTHLY
