CREATE OR REPLACE PROCEDURE SP_IFRS_LI_ACCT_EIR_GS_INSERT
AS
  V_CURRDATE DATE;
  V_PREVDATE DATE;
  V_VI NUMBER(19);
...
BEGIN
    ...
    --execute immediate 'create index psak_goal_seek_result_idx1 on IFRS_LI_ACCT_EIR_GS_RESULT(masterid,DOWNLOAD_DATE)';
    ...
    JOIN IFRS_LI_ACCT_EIR_GS_RESULT C ON C.MASTERID = A.MASTERID AND C.DOWNLOAD_DATE = V_CURRDATE
    ...
    INSERT  INTO IFRS_LI_ACCT_EIR_ECF
    ( MASTERID ,
      DOWNLOAD_DATE ,
      N_LOAN_AMT ,
      N_INT_RATE ,
