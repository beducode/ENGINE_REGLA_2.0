CREATE OR REPLACE PROCEDURE  SP_IFRS_NOMINATIVE_TRADE
AS
    v_CURRDATE      DATE;
    v_LASTMONTH     DATE;
    v_SESSIONID     VARCHAR2(100);
    v_SOURCETYPE    VARCHAR2(100):= 'TRADE';
    v_DATASOURCE    VARCHAR2(100):= 'BTRD';
...
BEGIN
    ...
    SELECT
        ...
        IMA.RESERVED_FLAG_1                                                         AS BS_FLAG,
        IMA.RESERVED_VARCHAR_1                                                      AS SWIFT_CODE,
        IMA.RESERVED_VARCHAR_14                                                     AS BI_CODE
