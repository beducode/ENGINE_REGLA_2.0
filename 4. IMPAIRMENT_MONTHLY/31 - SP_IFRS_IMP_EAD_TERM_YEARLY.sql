...
BEGIN 
    ...
    ELSE 
        ...
        V_TABLEINSERT3 := 'IFRS_EAD_TERM_YEARLY';
    ...
    IF P_PRC = 'S' THEN
        ...
        V_STR_QUERY := '';
        V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE ' || V_TABLEINSERT3 || ' AS SELECT * FROM IFRS_EAD_TERM_YEARLY WHERE 0=1';
        EXECUTE (V_STR_QUERY);
    END IF;
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMP_IFRS_EAD_TERM_YEARLY_' || P_RUNID || ' AS
