...
BEGIN 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TEMP_DEFAULT_' || P_RUNID || ' AS TABLE IFRS_DEFAULT WITH NO DATA';
    EXECUTE (V_STR_QUERY);
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE TMPRULE_' || P_RUNID || ' (DEFAULT_RULE_ID BIGINT)';
    EXECUTE (V_STR_QUERY);
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TEMP TABLE UPDATE_TEMP_DEFAULT_' || P_RUNID || ' AS
