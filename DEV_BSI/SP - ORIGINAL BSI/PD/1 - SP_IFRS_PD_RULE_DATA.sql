...
BEGIN
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE ' || V_TAB_OWNER || '.GTMP_IFRS_PD_RULES_CONFIG' ; 
	 
    V_STR_QUERY := 'INSERT INTO ' || V_TAB_OWNER || '.GTMP_IFRS_PD_RULES_CONFIG (PKID, SYSCODE_PD, PD_RULE_NAME, SEGMENTATION_ID, PD_METHOD, START_HISTORICAL_DATE,' || 
