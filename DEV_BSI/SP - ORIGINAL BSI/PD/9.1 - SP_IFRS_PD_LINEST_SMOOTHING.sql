CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_PD_LINEST_SMOOTHING_DEV (
...
BEGIN
	...
	IF P_PRC = 'S' THEN
        PSAK413.SP_IFRS_CREATE_TABLE_SIMULATE('GTMP_LOGIT_ODR', V_TMP_LOGIT_ODR);
	...
	WITH CT1 AS (
			...
			FROM ' || V_TAB_OWNER || '.' || V_TMP_LOGIT_ODR || '
		),
		CT2 AS (
			SELECT 
				PD_RULE_ID,
