CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_LGD_UR_DETAIL_DEV (
...
AS
    ...
    V_SPNAME VARCHAR2(100) := 'SP_IFRS_LGD_UR_DETAIL_DEV';
...
BEGIN
	...
	IF P_PRC = 'S' THEN
        PSAK413.SP_IFRS_CREATE_TABLE_SIMULATE('IFRS_LGD_UR_DETAIL', V_TABLEINSERT1);   
    END IF;
