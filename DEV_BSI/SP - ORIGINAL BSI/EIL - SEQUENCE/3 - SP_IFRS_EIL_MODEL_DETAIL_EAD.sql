CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_EIL_MODEL_DETAIL_EAD_DEV (
...
BEGIN
    ...
    VALUES (
        ...
        b.EAD_RULE_ID,b."lifetime_date" ,B."lifetime_effective_date",nvl(b."is_override_lifetime",0),nvl(b."is_deleted",0), 'SP_IFRS_EIL_MODEL_DETAIL_EAD', sysdate 
    );
