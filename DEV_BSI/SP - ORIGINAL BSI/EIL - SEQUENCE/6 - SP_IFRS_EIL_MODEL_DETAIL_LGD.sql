CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_EIL_MODEL_DETAIL_LGD_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_EIL_MODEL_DETAIL_LGD_DEV';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    -- TABLE DETERMINATION
    ----------------------------------------------------------------
    V_TABLEINSERT1 := 'IFRS_EIL_MODEL_DETAIL_LGD';
    ...
    UPDATE SET  
        ...
        a.UPDATEDBY              = 'SP_IFRS_EIL_MODEL_DETAIL_LGD',
    ...
    VALUES (
        ...
        b.LGD_RULE_ID,b."lgd_date", b."effective_date",b."is_override_lgd",nvl(b."is_deleted",0), 'SP_IFRS_EIL_MODEL_DETAIL_LGD', sysdate 
    );
