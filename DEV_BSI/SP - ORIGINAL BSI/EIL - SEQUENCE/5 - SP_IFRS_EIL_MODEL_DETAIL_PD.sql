CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_EIL_MODEL_DETAIL_PD_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_EIL_MODEL_DETAIL_PD_DEV';
...
BEGIN
    ...
    UPDATE SET  
        ...
        a.UPDATEDBY              = 'SP_IFRS_EIL_MODEL_DETAIL_PD',
    ...
    VALUES (
        ...
        b.PD_RULE_ID,b.PD_MODEL_ID,b."effective_date",b."pd_date",b."is_override_pd",nvl(b."is_deleted",0), 'SP_IFRS_EIL_MODEL_DETAIL_PD', SYSDATE 
    );
