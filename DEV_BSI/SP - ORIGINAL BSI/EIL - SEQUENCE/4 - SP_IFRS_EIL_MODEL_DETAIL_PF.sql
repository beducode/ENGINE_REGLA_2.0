CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_EIL_MODEL_DETAIL_PF_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_EIL_MODEL_DETAIL_PF_DEV';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    MERGE IMERGE INTO IFRS_EIL_MODEL_DETAIL_PF a
    USING (
    ...
    WHEN MATCHED THEN
        UPDATE SET  
            a.UPDATEDBY              = 'SP_IFRS_EIL_MODEL_DETAIL_PF',
    ...
    WHEN NOT MATCHED THEN
        ...
        VALUES (
            ...
            b.LT_RULE_ID,b."is_deleted", 'SP_IFRS_EIL_MODEL_DETAIL_PF', SYSDATE 
    );
