CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_PD_TERM_STRUCTURE_VAS_DEV (
    ...
    V_SP_NAME        VARCHAR2(100) := 'SP_IFRS_PD_TERM_STRUCTURE_VAS_DEV';
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK;
        DBMS_OUTPUT.PUT_LINE('ERROR IN SP_IFRS_PD_TERM_STRUCTURE_VAS_DEV: ' || SQLERRM);
        RAISE;
END;
/
