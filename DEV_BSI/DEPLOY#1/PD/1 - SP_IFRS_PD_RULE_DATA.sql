CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_PD_RULE_DATA_DEV (
...
AS 
    ...
    V_IFRS_PD_RULE_DATA  			VARCHAR2(100);
    ...
    V_SP_NAME       VARCHAR2(100) := 'SP_IFRS_PD_RULE_DATA_DEV';
...
BEGIN
    ...
    IF P_PRC = 'S' THEN
        V_IFRS_PD_RULE_DATA  := 'IFRS_PD_RULE_DATA_' || P_RUNID;
    ...
    ELSE
        V_IFRS_PD_RULE_DATA  := 'IFRS_PD_RULE_DATA';
        V_TMP_PD  := 'TMP_PD';
    ...
    IF P_PRC = 'S' THEN
        PSAK413.SP_IFRS_CREATE_TABLE_SIMULATE('IFRS_PD_RULE_DATA', V_IFRS_PD_RULE_DATA);
    ...
    EXECUTE IMMEDIATE 'TRUNCATE TABLE ' || V_IFRS_PD_RULE_DATA || '';
    ...
    -----------------------------
    V_TABLEDEST := V_TAB_OWNER || '.' || V_IFRS_PD_RULE_DATA;
    V_COLUMNDEST := '-';
    V_OPERATION := 'INSERT';
    ...
    V_QUERYS := 'SELECT * FROM ' || V_TAB_OWNER || '.' || V_IFRS_PD_RULE_DATA;
