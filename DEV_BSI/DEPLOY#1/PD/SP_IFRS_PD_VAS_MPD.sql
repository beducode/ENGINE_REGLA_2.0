CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_PD_VAS_MPD_DEV (
...
AS
    ...
    V_SP_NAME        VARCHAR2(100) := 'SP_IFRS_PD_VAS_MPD_DEV';
...
BEGIN
    ...
    V_STR_QUERY := '
        ...
        EXECUTE IMMEDIATE V_STR_QUERY USING V_FL_PRC + 1, V_CURRDATE, V_FL_PRC;
    ...
    V_STR_QUERY := '
        ...
        EXECUTE IMMEDIATE V_STR_QUERY USING V_CURRDATE, V_FL_PRC;
