CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_SEGMENTATION_MAPPING_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_SEGMENTATION_MAPPING_DEV';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
    ...
    -----------------------------------------------------------------
        ...
        WHEN MATCHED THEN
            UPDATE SET  
                ...
                a.UPDATED_BY              = 'SP_IFRS_SEGMENTATION_MAPPING_DEV',
