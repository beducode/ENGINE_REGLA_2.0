CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_DEFAULT_CRITERIA_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_DEFAULT_CRITERIA_DEV';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
    ...
    MERGE INTO IFRS_DEFAULT_CRITERIA a
        ...
        WHEN MATCHED THEN
            UPDATE SET  
                ...
                a.UPDATED_BY              = 'SP_IFRS_DEFAULT_CRITERIA_DEV',
        ...
        WHEN NOT MATCHED THEN
            ...
            VALUES (
                ...
                nvl(b."is_deleted", 0),
                'SP_IFRS_DEFAULT_CRITERIA_DEV', sysdate
            );
