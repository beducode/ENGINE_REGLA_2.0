CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_BUCKET_HEADER_DEV (
...
AS
    ...
    -- VARIABLES
    ----------------------------------------------------------------
    V_SP_NAME     VARCHAR2(100) := 'SP_IFRS_BUCKET_HEADER_DEV';
    V_OWNER       VARCHAR2(30);
    V_CURRDATE      DATE;
...
BEGIN
    ...
    MERGE INTO IFRS_BUCKET_HEADER a
        ...
        WHEN MATCHED THEN
            UPDATE SET   
                a.UPDATED_BY              = 'SP_IFRS_BUCKET_HEADER_DEV',
        ...
        WHEN NOT MATCHED THEN
            ...
            VALUES (
                ...
                'SP_IFRS_BUCKET_HEADER_DEV', sysdate ,
