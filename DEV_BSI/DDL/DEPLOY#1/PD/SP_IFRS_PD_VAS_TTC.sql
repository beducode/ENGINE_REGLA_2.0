CREATE OR REPLACE PROCEDURE PSAK413.SP_IFRS_PD_VAS_TTC_DEV (
    ...
    V_SP_NAME        VARCHAR2(100) := 'SP_IFRS_PD_VAS_TTC_DEV';
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK;
        DBMS_OUTPUT.PUT_LINE('ERROR IN SP_IFRS_PD_VAS_TTC_DEV: ' || SQLERRM);
        RAISE;
END;
/
