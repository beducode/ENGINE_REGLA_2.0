...
BEGIN
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE ' || V_TABLEPDCONFIG || '' ; 
    ...
    IF P_PRC = 'S' THEN
		PSAK413.SP_IFRS_CREATE_TABLE_SIMULATE('GTMP_PD_RUNNING_CONFIG', V_TABLEINSERT1);
        PSAK413.SP_IFRS_CREATE_TABLE_SIMULATE('IFRS_PD_MAA_ENR', V_TABLEINSERT2);
    END IF;
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK;
        DBMS_OUTPUT.PUT_LINE('ERROR IN SP_IFRS_PD_MAA_ENR: ' || SQLERRM);
        RAISE;
