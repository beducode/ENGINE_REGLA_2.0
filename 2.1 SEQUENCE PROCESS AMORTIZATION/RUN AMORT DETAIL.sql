...
CALL SP_IFRS_SYNC_UPLOAD_TRAN_DAILY(); -- 5
CALL SP_IFRS_AC_SYNC_LIST_VALUE(); -- 6
CALL SP_IFRS_AMT_INITIAL_UPDATE(); -- 7
-- CALL SP_IFRS_EXEC_RULE -- 8 SKIP
-- CALL SP_IFRS_TRX_PRORATE -- 9 SKIP
...
CALL SP_IFRS_ACCT_COST_FEE_SUMM(); -- 15
CALL SP_IFRS_ACCT_SWITCH(); -- 16
CALL SP_IFRS_ACCT_SL_SWITCH(); -- 17
CALL SP_IFRS_ACCT_EIR_SWITCH(); -- 18
CALL SP_IFRS_ACCT_EIR_ACF_PMTDT(); -- 19
