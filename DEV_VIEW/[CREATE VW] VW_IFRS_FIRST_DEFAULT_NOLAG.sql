DROP VIEW IF EXISTS VW_IFRS_FIRST_DEFAULT_NOLAG;

CREATE VIEW VW_IFRS_FIRST_DEFAULT_NOLAG AS
WITH CTE_VIEW            
(              
    RULE_ID,    
    MASTERID,      
...
(              
    SELECT        
        ...
        EQV_OS_12M_BEFORE_DEFAULT,    
        FACILITY_NUMBER,    
        ROW_NUMBER() OVER (PARTITION BY RULE_ID, FACILITY_NUMBER ORDER BY DOWNLOAD_DATE ASC) RN    
