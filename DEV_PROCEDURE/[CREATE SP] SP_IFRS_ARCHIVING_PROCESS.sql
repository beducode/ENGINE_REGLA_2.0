...
BEGIN 
    ...
    EXECUTE 'SELECT * FROM dblink(''link_ntt_parameter'', ''SELECT retention_id, connection_id, table_source, table_destination, sequence, table_condition_result, table_condition, connection_key FROM VW_DATA_RETENTION_POLICY'') 
