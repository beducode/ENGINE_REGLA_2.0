---- DROP PROCEDURE SP_IFRS_IMP_FILL_IMA_PREV_CURR_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_FILL_IMA_PREV_CURR_ECL(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_IMP_FILL_IMA_PREV_CURR_ECL | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT1;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_FILL_IMA_PREV_CURR_ECL';
    V_OPERATION = 'INSERT';
