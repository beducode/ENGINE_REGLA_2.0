---- DROP PROCEDURE SP_IFRS_IMP_SYNC_IMA_MONTHLY_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_SYNC_IMA_MONTHLY_ECL(
...
BEGIN 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || 'CREATE TABLE UPDATE_TMP_IFRS_IMA_IMP_CURR_' || P_RUNID || ' AS
    ...
    RAISE NOTICE 'SP_IFRS_IMP_SYNC_IMA_MONTHLY_ECL | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLENAME;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_SYNC_IMA_MONTHLY_ECL';
    V_OPERATION = 'INSERT';
