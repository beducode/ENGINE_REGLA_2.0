---- DROP PROCEDURE SP_IFRS_IMP_EAD_TERM_YEARLY_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_EAD_TERM_YEARLY_ECL(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_IMP_EAD_TERM_YEARLY_ECL | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT3;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_EAD_TERM_YEARLY_ECL';
    V_OPERATION = 'INSERT';
