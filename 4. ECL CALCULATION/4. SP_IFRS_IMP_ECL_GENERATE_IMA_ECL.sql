---- DROP PROCEDURE SP_IFRS_IMP_ECL_GENERATE_IMA_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_ECL_GENERATE_IMA_ECL(
...
FROM
    ...
    RAISE NOTICE 'SP_IFRS_IMP_ECL_GENERATE_IMA_ECL | AFFECTED RECORD : %', V_RETURNROWS2;

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT1;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_ECL_GENERATE_IMA_ECL';
    V_OPERATION = 'INSERT';
