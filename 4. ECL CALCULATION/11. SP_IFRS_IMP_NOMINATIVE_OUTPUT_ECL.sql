---- DROP PROCEDURE SP_IFRS_IMP_NOMINATIVE_OUTPUT_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_NOMINATIVE_OUTPUT_ECL(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_IMP_NOMINATIVE_OUTPUT_ECL | AFFECTED RECORD : %', V_RETURNROWS2;
    ---------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT1;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_NOMINATIVE_OUTPUT_ECL';
    V_OPERATION = 'INSERT';
