---- DROP PROCEDURE SP_IFRS_ECL_RESULT_DETAIL_OLD;

CREATE OR REPLACE PROCEDURE SP_IFRS_ECL_RESULT_DETAIL_OLD(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_ECL_RESULT_DETAIL_OLD | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT3;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_ECL_RESULT_DETAIL_OLD';
    V_OPERATION = 'INSERT';
