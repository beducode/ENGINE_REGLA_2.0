---- DROP PROCEDURE SP_IFRS_TESTING_EIL_CONFIG;

CREATE OR REPLACE PROCEDURE SP_IFRS_TESTING_EIL_CONFIG(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_TESTING_EIL_CONFIG | AFFECTED RECORD : %', V_RETURNROWS2;
    ---------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLENAME;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_TESTING_EIL_CONFIG';
    V_OPERATION = 'INSERT';
