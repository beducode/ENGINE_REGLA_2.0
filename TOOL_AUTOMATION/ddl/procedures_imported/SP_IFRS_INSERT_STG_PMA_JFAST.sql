CREATE OR REPLACE EDITIONABLE PROCEDURE "PSAK413"."SP_IFRS_INSERT_STG_PMA_JFAST" 
(
    P_RUNID         VARCHAR2,
...
BEGIN
	...
	-- set procedure name
    V_SPNAME := 'SP_IFRS_INSERT_STG_PMA_JFAST';
    ...
    */
    ...
    V_STR_QUERY := '
			...
			AND SOURCE_PROCESS = ''CKPN_PMA_JFAST''
        ';
	...
	,A.RESTRUCTURE_DATE
	,A.DEFAULT_DATE
	,''CKPN_PMA_JFAST'' AS SOURCE_PROCESS
	,A.AYDA
